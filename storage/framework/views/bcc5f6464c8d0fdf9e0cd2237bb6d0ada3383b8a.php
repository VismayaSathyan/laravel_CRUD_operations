...
<?php $__env->startSection('title', 'My Archive'); ?>
<?php $__env->startSection('myArchive'); ?>
...
<tbody>
    ...
    <?php endif; ?>
        ...
        <a   href="<?php echo e(route('products.myProducts')); ?>"><button class="btn btn-dark ">My Products List</button></a>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelCRUD\resources\views/products/myArchivedProducts.blade.php ENDPATH**/ ?>